...
?>
      <div class="row banner">
         <div class="banner-text">
            <h1 class="responsive-headline upper">I'm <?php echo isset($user) ? ucwords($user['firstname'].' '.$user['lastname']) : ""; ?>.</h1>
            <h3 class="white"><?php echo stripslashes($_settings->info('welcome_message')) ?></h3>
            <hr />
            <ul class="social">
            ...
            <div class="ten columns flex-container">
               ...
               <div class="flexslider">
                  ...
                  <ul class="slides">
                     ...
                     <li>
                        <blockquote>
                           <p>I have worked with ouafae on two complex projects and in both cases, the work was done on time, on budget, and with a high degree of professionalism.
Across the board, everyone enjoyed working with ouafae. ouafae not only did exceptional work based on the specs we gave him for each project, but he also gave input on how to make the end product even better and cared about how users would engage with the builds. I will be using Ian again in the future and would highly recommend his services to anyone

                           </p>
                           <cite>Akhrif jaafar</cite>
                        </blockquote>
                     </li> <!-- slide ends -->

                     <li>
                        <blockquote>
                           <p>It has been a real pleasure working with ouafae. she has been very professional and very clear in all communications, which I appreciate.

                           </p>
                           <cite>bouchloch yassin</cite>
                        </blockquote>
                     </li> <!-- slide ends -->
